...
- apt_repository/yum_repository: Add/remove simple repo file entries; run apt update or yum/dnf makecache on change.
...
### Network & Filesystem
- get_url: `url`, `dest`, optional `checksum`; idempotent via ETag/checksum; uses curl/wget.
...
3. Implement get_url, unarchive, cron, mount, git, pip.
...
- Phase 2: get_url, unarchive, cron, mount, git, pip, repositories.
